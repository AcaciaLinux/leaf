...
namespace Error{
	...
	enum ec{
		...
		//Package
		PACKAGE_DEP_NOT_FOUND = 90,
		PACKAGE_UNEXPECTED_EOF = 91,
		PACKAGE_STOI = 92,
		PACKAGE_FILE_EXISTS = 93,
		PACKAGE_FETCH_DEST_EMPTY = 94,
		PACKAGE_SCRIPT_FAILED = 95,
		PACKAGE_PARSE_INSTALLEDFILE = 96,
